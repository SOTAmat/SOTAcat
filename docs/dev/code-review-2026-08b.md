...
| UR-21 | Mouse drag rebuilds full band chart (incl. per-spot ticks) every pointermove          | run.js:631-639,563,267,372,423-434                | V   | 1   | 2    | 3   | 2   | U11   | fixed 71cb93d |
| UR-22 | loadCwMacrosAsync refetches unconditionally; Run-appear awaits serialized             | run.js:1510-1527; main.js:232                     | V   | 1   | 3    | 2   | 1   | U11   | fixed 71cb93d (parallelized; refetch guard declined) |
| UR-23 | Spots auto-refresh (500-spot fetch + full localStorage serialize) runs with tab hidden | spots.js:191-201,11-12,30-33                     | V   | 1   | 3    | 3   | 2   | U11   | declined: platform throttling / marginal gain; see #141 |
| UR-24 | VFO poll issues 2 GETs (frequency + mode) per 3 s tick                                | main.js:828-831                                   | V   | 1   | 1    | 2   | 1   | U11   | declined: platform throttling / marginal gain; see #141 |
| UR-25 | QRX appear fetches /api/v1/gps twice (loadGpsLocation + getLocation)                  | qrx.js:587-591,73; main.js:1640-1656              | V   | 1   | 3    | 2   | 1   | U11   | declined: platform throttling / marginal gain; see #141 |
...
| UR-30 | loadTabScriptIfNeeded fetches script then re-requests via script tag (no-cache)       | main.js:1244-1267; webserver.cpp:230              | V   | 1   | 2    | 3   | 1   | U11   | declined: platform throttling / marginal gain; see #141 |
