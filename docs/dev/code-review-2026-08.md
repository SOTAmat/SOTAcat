...
| CR-11 | Legacy stored tab names (wrx/cat/sota/pota) → alert + blank on load                            | main.js:1119-1127                              | V         | 2   | 3    | 2   | 2   | B9        | fixed c41a92d |
| CR-12 | Run-tab appear/leave race (unawaited hooks, no re-entrancy guard)                              | run.js:1649-1676, main.js:1272                 | V         | 2   | 2    | 2   | 2   | B9        | fixed c41a92d |
| CR-13 | PoLo spot button enabled with null frequency; failure is log-only                              | run.js:1377,1475-1483                          | V         | 2   | 3    | 2   | 1   | B9        | fixed c41a92d |
...
| CR-16 | Manual version check returns before timestamp/retry bookkeeping                                | main.js:1831-1877                              | V         | 2   | 3    | 2   | 1   | B9        | fixed c41a92d |
| CR-17 | "Refreshed 0:00 ago" after cache restore (timestamp never set)                                 | chase.js:1217-1232                             | V         | 2   | 3    | 2   | 2   | B7        | fixed 1328378 |
| CR-18 | Mid-edit VFO poll stomps display (no edit-mode suppression)                                    | run.js:1016-1020                               | V         | 1   | 2    | 1   | 2   | B8        | fixed 2bf41df |
| CR-19 | run.js duplicates main.js VFO polling stack minus its guards                                   | run.js:1016,1092,865 vs main.js:810+           | V         | 2   | 1    | 1   | 2   | B8        | fixed 2bf41df |
| CR-20 | Debounce `finally` nulls shared timer handle without comparison                                | run.js:895-919                                 | V(plaus.) | 1   | 3    | 1   | 1   | B8        | fixed 2bf41df |
| CR-21 | CW macros wiped via offline-at-load fallback path                                              | settings.js:463-475                            | V(plaus.) | 2   | 2    | 2   | 1   | B14       | narrowed 2d1cb05: offline reads never touch caches |
| CR-22 | visibilitychange refresh no-ops if a controller was in flight                                  | main.js:1367-1374                              | V(plaus.) | 1   | 2    | 2   | 1   | B9        | fixed c41a92d |
| CR-23 | FT8 guard: duplicated struct, defeated by manual clears, unguarded tail                        | handler_ft8.cpp:840,954,986-1098               | V         | 1   | 2    | 3   | 1   | B12       | declined: correct today, revisit if FT8 code reopens |
| CR-24 | MAX17260 learned params never persisted; dead write_learned_params                             | max17260.cpp:246,316                           | S         | 2   | 2    | 3   | 2   | B17       | fixed 2a25b59 |
...
| CR-32 | Throwaway socket created/configured/closed every 60 s                                          | wifi.cpp:794-820                               | S         | 1   | 3    | 3   | 1   | B18       | fixed e7fbfd9 |
| CR-33 | Every API reply sends `Connection: close` vs configured keep-alive                             | webserver.h:111,125 vs webserver.cpp:328       | S         | 2   | 2    | 3   | 2   | B18       | fixed e7fbfd9 |
| CR-34 | 16-sample ADC average computed and discarded when MAX17260 present                             | battery_monitor.cpp:218                        | S         | 1   | 3    | 2   | 1   | B17       | fixed 2a25b59 |
| CR-35 | mdns forced to DEBUG log level in every build                                                  | main.cpp:9                                     | S         | 1   | 3    | 3   | 1   | B19       | fixed 82c7e52 |
| CR-36 | "above 80%" comments vs BATTERY_SHUTOFF_PERCENTAGE 70 (×2)                                     | setup.cpp:38, idle_status_task.cpp:85          | S         | 1   | 3    | 2   | 1   | B17       | fixed 2a25b59 |
| CR-37 | REPORTING_TIME_SEC=10 is a divisor; real cadence 50 s                                          | battery_monitor.cpp:12                         | S         | 1   | 3    | 2   | 1   | B17       | fixed 2a25b59 |
...
| CR-43 | MAX_TUNE_TARGETS/MAX_CW_MACROS unused in C++; JS re-hardcodes 5/8                              | settings.h:49-57, settings.js:125,457          | S         | 1   | 2    | 2   | 1   | B11       | fixed 77142ac |
...
| CR-45 | JSON POST body-read block copied 6× with drift (uninit buffer, 404 vs 408)                     | handler_settings.cpp:340+                      | S         | 2   | 2    | 1   | 1   | B11       | fixed 77142ac |
| CR-46 | GET dance copied 5× with drift; no radio_get_via_http counterpart                              | handler_frequency.cpp:49 et al.                | R         | 2   | 1    | 1   | 1   | B15       | fixed b9e7a31 |
| CR-47 | adjust_kh1_time_component verbatim copy of KX version                                          | radio_driver_kh1.cpp:102 vs kx.cpp:27          | R         | 1   | 2    | 1   | 1   | B13       | declined: revisit with KH1 on bench |
| CR-48 | KH1 reimplements write-verify loop; no WDT feed; leaf band limit                               | radio_driver_kh1.cpp:150                       | R         | 2   | 2    | 1   | 1   | B13       | declined: revisit with KH1 on bench |
| CR-49 | 8 hand-rolled DS fixed-offset extractions, inconsistent buffers                                | radio_driver_kh1.cpp:25+                       | R         | 1   | 2    | 1   | 1   | B13       | declined: revisit with KH1 on bench |
| CR-50 | settings.js re-implements main.js loaders; caches left stale                                   | settings.js:22,133,463                         | R         | 2   | 2    | 1   | 1   | B14       | micro-fixed 2d1cb05; remainder already true |
| CR-51 | wait_for_tx_end: TQ every 100 ms × 60 s, results discarded                                     | radio_driver_kx.cpp:222                        | R         | 1   | 2    | 2   | 1   | B16       | fixed 7b050ab |
| CR-52 | SET_VOLUME discards driver-known level; forces re-read round trips                             | radio_service.cpp:290, radio_driver_kx.cpp:121 | R         | 1   | 2    | 2   | 1   | B16       | not fixed: no consumer |
| CR-53 | Three ping-and-record-health paths disagree (throttle stamp)                                   | radio_service.cpp:109,126,238                  | R         | 2   | 2    | 2   | 1   | B16       | refuted: already stamped |
| CR-54 | Per-command UART timeout table hardcoded in transport; KH1 DS pinned at 100 ms                 | kx_radio.cpp:302,477                           | R         | 2   | 2    | 2   | 1   | B16       | fixed 7b050ab |
