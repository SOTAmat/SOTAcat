...
|-------|------------------------------------------------------------------------------------------------|------------------------------------------------|-----------|-----|------|-----|-----|-----------|--------|
| CR-01 | DATA-REV mode panics device (mode map index ≠ enum)                                            | handler_mode.cpp:23-49                         | V         | 3   | 3    | 3   | 2   | B1        | open   |
| CR-02 | Chunk-send fall-through: silent truncation as HTTP 200, httpd stalls                           | webserver.cpp:171-212                          | V         | 3   | 3    | 3   | 2   | B3        | open   |
...
| CR-15 | Coordinate 0 treated as "no location" (falsy check on numbers)                                 | qrx.js:192, main.js:1551                       | V         | 2   | 3    | 2   | 1   | B5        | open   |
