...
esp_err_t Max17620::poll(max17260_info_t* info){
    ...
    ESP_LOGV(TAG8, "RemCap: %3.1fmAh SOC: %2.1f%% TTE: %3.2fhr TTF: %3.2fhr", info->reported_capacity, 
                                                                              ...
                                                                              info->time_to_empty,
                                                                              info->time_to_full);
    ESP_LOGV(TAG8, "V: %3.2fV Va: %3.2fV I: %3.2fmA Ia: %3.2fmA", info->voltage,
                                                                  info->voltage_average, 
                                                                  info->current, 
                                                                  info->current_average);
    ESP_LOGV(TAG8, "T: %2.1f Ta: %2.1f P: %3.2fmW Pa: %3.2fmW", info->temperature, 
                                                                info->temperature_average, 
                                                                info->power, 
                                                                info->power_average);
