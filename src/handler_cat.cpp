...
esp_err_t handler_power_get (httpd_req_t * req) {
    ...
    return radio_get_via_http (req, RadioCmdType::REFRESH_POWER, RadioParkKind::GET_POWER, snap, snap.power_fresh (now), snap.has_power(), send_power, power_get_complete);
}
