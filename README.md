...
- Justin K5EM and Rex KE6MT: Created derivative hardware versions, custom SMT PCBs, and helped with packaging analysis, circuit analysis, and testing.
    - See [https://github.com/invertedlabs/sotacat-pcb/](Justin's SOTACAT-PCB Github page) for an open source custom PCB (printed circuit board) that implements SOTACAT in a compact and professional way, as well as 3D printing files for an enclosure.
